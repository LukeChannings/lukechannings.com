...
**TL;DR**: [No](https://en.wikipedia.org/wiki/Betteridge's_law_of_headlines), but if you subtract `env(safe-area-inset-bottom)` from `100vh` you'll get what you expect.
...
it has a header at the top, a button at the bottom, all wrapped in a `100vh` container.
...
<div className="image-group-figure">
  <figure>
    <video src={ios14SafeAreaInsetBottomUrl} loop muted autoplay></video>
    <figcaption>
      Safari 14 with <strong>100vh - safe-area-inset-bottom</strong>
    </figcaption>
  </figure>
  <figure>
    <video src={ios15SafeAreaInsetBottomUrl} loop muted autoplay></video>
    <figcaption>
...
[Jen Simmons](https://jensimmons.com)[^5] was asking for feedback regarding viewport
height issues.
...
<blockquote class="twitter-tweet">
  ...
  &mdash; Jen Simmons (<a href="https://twitter.com/jensimmons">@jensimmons</a>){" "}
  <a href="https://twitter.com/jensimmons/status/1393554029721104384?ref_src=twsrc%5Etfw">
    May 15, 2021
  </a>
</blockquote>
...
<blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    ...
    <a href="https://t.co/hAwSMjMzWj">https://t.co/hAwSMjMzWj</a>
    <a href="https://t.co/DPfTZ2xrUN">https://t.co/DPfTZ2xrUN</a>
    <br />
    <br />
  ...
  &mdash; Jen Simmons (<a href="https://twitter.com/jensimmons">@jensimmons</a>){" "}
  <a href="https://twitter.com/jensimmons/status/1402028742772408327?ref_src=twsrc%5Etfw">
    June 7, 2021
  </a>
</blockquote>
...
[^5]: Jen Simmons left Mozilla to join Apple in June 2020. She has been contributing hugely to the WebKit team, and has pushed the team to fix problems around tooling and compatibility.
